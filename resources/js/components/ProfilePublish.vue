<template>
 ...
 export default {
  ...
  data() {
      ...
      created(){
                    this.axios.get('/nusfacilities').then(response => {
                        this.nusfacilities = response.data;    
      
                    });
                    
                    this.axios.get('/cooperatemedical').then(response => {
                        this.cooperate_medical = response.data;    
                       
                    });

                      this.axios.get('/medicalacceptance').then(response => {
                        this.medical_acceptance = response.data;    
                        
                    });
 
                      this.axios.get('/staff').then(response => {
